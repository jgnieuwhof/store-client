...
const faqs = [
  ...
  [`Can you resize rings?`, `Yes and no. We can normally size up a ring by about 1 US ring size. After that the band would just become too thin. We are not able to size a ring down as the stone has already been set in my ready made rings and the process of sizing down can damage the stone. If you’re unsure, just send us a quick inquiry and we can let you know if it’s possible for the ring you’re looking at!`],
